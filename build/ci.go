...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/IgorFilipovich/go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/IgorFilipovich/go-ethereum/internal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/IgorFilipovich/go-ethereum/core/rawdb", "github.com/IgorFilipovich/go-ethereum/ethdb/leveldb"},
		{"github.com/IgorFilipovich/go-ethereum/core/rawdb", "github.com/IgorFilipovich/go-ethereum/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
